...
def find_rooms_test_img(img_orig,img, name, noise_removal_threshold=70, corners_threshold=0.1,
               room_closing_max_length=50, gap_in_wall_threshold=50):
    """
